      ...
      <div className={styles.page}>
        <div className={styles.banner} role="alert">
          ...
          <p style={{ margin: '8px 0 0' }}>
            Start Judge0 locally with{' '}
            <code>docker compose -f docker-compose.judge0.yml up -d</code>, then set{' '}
            <code>JUDGE0_API_URL</code> and <code>JUDGE0_AUTH_TOKEN</code> in your API{' '}
