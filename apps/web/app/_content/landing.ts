...
export const heroBadge = 'Early Access · For instructors and students';

export const heroSub =
  'One platform for courses, projects, planning, and delivery. Templates, teams, Hassona, community, competitions, and GitHub submissions — connected.';

export const statsBar = [
  { number: '15+', label: 'Integrated workflows in one system' },
  { number: '1', label: 'GitHub-native submission flow' },
...
export const mockupStatCards = [
  ...
  { label: 'Community', value: '24', sub: 'Active threads' },
...
export const howItWorksSteps = [
  ...
  },
  {
    ...
    desc: 'Collect role applications, generate teams, run community discussions, and route petitions without losing the thread.',
    cta: 'View CLI guide →',
  ...
  },
  {
    ...
    desc: 'Students submit from the terminal, use Hassona for help, and instructors review with analytics visible all semester.',
    cta: null,
    href: null,
  },
] as const;
...
export const transformPains = [
  ...
  'AI help, peer forums, and competitive practice scattered across separate apps',
] as const;
...
export const transformGains = [
  ...
  'Hassona, community, competitions, and achievements live beside courses and planning',
] as const;

export const transformSub =
  'See what changes when courses, planning, submissions, tutoring, and student engagement finally live together.';
    ...
    features: [
      {
        icon: 'hassona',
        title: 'Hassona',
        desc: 'Chat with an AI tutor, review learning insights, use smart routing, and get grade-aware recommendations.',
      },
      {
        icon: 'community',
        title: 'Community',
        desc: 'Ask questions, share answers, and join course-scoped discussions without leaving Nibras.',
      },
      {
        icon: 'competitions',
        title: 'Competitions',
        desc: 'Run contests, practice with Nibras 75 and multi-platform problems, track rankings, and review contest history.',
      },
      {
        icon: 'achievements',
        title: 'Achievements',
        desc: 'Earn badges, build reputation, climb leaderboards, and track level progression tied to real activity.',
      },
    ],
  },
];
...
export const testimonials = [
  ...
  {
    quote:
      'I used to bounce between Discord, LeetCode, and our LMS. With Hassona, community, and Nibras 75 in the same place as my projects, I always know what to work on next.',
    name: 'Alex Rivera',
